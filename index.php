...
<body>
  <div class="header">
    <div class="nav-bar">
      <a href="#" class="nav-bar-home">
        <!-- Đừng mở thẻ svg -->
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 141 32" fill="none" class="nav-bar-home-img">
      ...
      <form action="" class="nav-bar-form">
        <input type="text" placeholder="Bạn cần tìm gì?" class="nav-bar-search" />
        <button type="" class="nav-bar-search-btn">
          <i class="fa fa-search"></i>
        </button>
      </form>
      <a href="#" class="nav-bar-item"><i class="fa-solid fa-headphones"></i>Hotline</a>
      <a href="#" class="nav-bar-item"><i class="fa-solid fa-location-dot"></i>Hệ thống showroom</a>
      <a href="#" class="nav-bar-item"><i class="fa-solid fa-clipboard-list"></i>Tra cứu đơn hàng</a>
      <a href="giohang/giohang.html" class="nav-bar-item"><i class="fa-solid fa-cart-shopping"></i>Giỏ hàng</a>
      <a href="dangnhap/dangnhap.php" class="nav-bar-item nav-bar-login"><i class="fa-solid fa-user"></i>Đăng nhập</a>
    </div>
  </div>
  <div class="sub-nav-bar">
    <div class="fake-background"></div>
    <div class="sub-nav-bar-wrap">
      <a href="#" class="sub-nav-bar-item" style="border: none">Tổng hợp khuyến mãi</a>
      <a href="#" class="sub-nav-bar-item">Tin công nghệ</a>
      <a href="#" class="sub-nav-bar-item">Video</a>
      <a href="#" class="sub-nav-bar-item">Hướng dẫn thanh toán</a>
      <a href="#" class="sub-nav-bar-item">Hướng dẫn trả góp</a>
      <a href="#" class="sub-nav-bar-item">Chính sách bảo hành</a>
    </div>
  </div>
  <div class="main-body">
    <div class="side-bar">
      <ul class="category">
        <li class="category-item">
          <a href="">Laptop<i class="fa-solid fa-angle-right"></i></a>
        </li>
        <li class="category-item">
          <a href="">Laptop Gaming<i class="fa-solid fa-angle-right"></i></a>
        </li>
        <li class="category-item">
          <a href="">PC KM Đặc Biệt<i class="fa-solid fa-angle-right"></i></a>
        </li>
        <li class="category-item">
          <a href="">PC Gaming<i class="fa-solid fa-angle-right"></i></a>
        </li>
        <li class="category-item">
          <a href="">PC Đồ Họa<i class="fa-solid fa-angle-right"></i></a>
        </li>
        <li class="category-item">
          <a href="">PC Doanh Nghiệp<i class="fa-solid fa-angle-right"></i></a>
        </li>
        <li class="category-item">
          <a href="">Linh kiện PC<i class="fa-solid fa-angle-right"></i></a>
        </li>
        <li class="category-item">
          <a href="">Apple<i class="fa-solid fa-angle-right"></i></a>
        </li>
        <li class="category-item">
          <a href="">Màn hình<i class="fa-solid fa-angle-right"></i></a>
        </li>
        <li class="category-item">
          <a href="">Bàn phím<i class="fa-solid fa-angle-right"></i></a>
        </li>
        <li class="category-item">
          <a href="">Chuột<i class="fa-solid fa-angle-right"></i></a>
        </li>
        <li class="category-item">
          <a href="">Tai nghe - Loa<i class="fa-solid fa-angle-right"></i></a>
        </li>
        <li class="category-item">
          <a href="">Ghế - Bàn<i class="fa-solid fa-angle-right"></i></a>
        </li>
        <li class="category-item">
          <a href="">Phần mềm<i class="fa-solid fa-angle-right"></i></a>
        </li>
        <li class="category-item">
          <a href="">Phụ kiện<i class="fa-solid fa-angle-right"></i></a>
        </li>
        <li class="category-item">
          <a href="">Thủ thuật - Giải đáp<i class="fa-solid fa-angle-right"></i></a>
        </li>
      </ul>
    </div>
    <div class="big-body">
      <img src='images/ad1png.png' alt='' class='big-image' />
      <div class="lower-body-wrapper">
        <img src="images/ad2png.png" alt="" class="small-image" />
        <img src="images/ad3png.png" alt="" class="small-image" />
      </div>
    </div>
    <div class="small-body">
      <img src="images/ad2png.png" alt="" class="another-small-image" />
      <img src="images/ad3png.png" alt="" class="another-small-image" />
      <img src="images/ad2png.png" alt="" class="another-small-image" />
    </div>
  </div>
  <div class="product-list">
    <div class="product-list-header">
      <h4 class="product-list-header-title">Laptop gaming bán chạy</h4>
      <ul class="product-list-header-brands">
        <li class="product-list-header-brands-item"><a href="">Asus</a></li>
        <li class="product-list-header-brands-item"><a href="">Msi</a></li>
        <li class="product-list-header-brands-item"><a href="">Lenovo</a></li>
        <li class="product-list-header-brands-item"><a href="">Dell</a></li>
        <li class="product-list-header-brands-item"><a href="">LG</a></li>
        <li class="product-list-header-brands-item"><a href="">Acer</a></li>
      </ul>
    </div>
    <div class="product-list-body">
      <div class="product-list-item-showcase">
        <img src="images/item.png" alt="" class="product-list-item-showcase-img" />
        <div class="product-list-item-showcase-wrapper">
          <p class="product-list-item-showcase-name">
            Laptop Lenovo Ideapad Gaming 3 15IAH7 82S9006YVN
          </p>
          <p class="product-list-item-old-price">26.990.000đ</p>
          <p class="product-list-item-new-price">18.990.000đ</p>
          <p class="discount-percentage">-29%</p>
        </div>
      </div>
      <div class="product-list-item-showcase">
        <img src="images/item.png" alt="" class="product-list-item-showcase-img" />
  ...
  <div class="product-list">
    <div class="product-list-header">
      <h4 class="product-list-header-title">Laptop văn phòng bán chạy</h4>
      <ul class="product-list-header-brands">
        <li class="product-list-header-brands-item"><a href="">Asus</a></li>
        <li class="product-list-header-brands-item"><a href="">Msi</a></li>
        <li class="product-list-header-brands-item"><a href="">Lenovo</a></li>
  ...
  <div class="footer">
    <div class="footer-upper">
      <div class="footer-column">
        <h6 class="footer-column-header">Về Gearvn</h6>
        <div class="footer-column-item"><a href="">Giới thiệu</a></div>
        <div class="footer-column-item"><a href="">Tuyển dụng</a></div>
      </div>
      <div class="footer-column">
        <h6 class="footer-column-header">Chính sách</h6>
      ...
      <div class="footer-column">
        <h6 class="footer-column-header">Thông tin</h6>
        <div class="footer-column-item"><a href="">Hệ thống cửa hàng</a></div>
        <div class="footer-column-item">
          <a href="">Trung tâm bảo hành</a>
        </div>
      </div>
      <div class="footer-column">
        <h6 class="footer-column-header">Tổng đài hỗ trợ</h6>
        <div class="footer-column-item footer-special-item">
          Gọi mua: <a href="">1800.0000</a>
        </div>
        <div class="footer-column-item footer-special-item">
          CSKH: <a href="">1800.0000</a>
        </div>
        <div class="footer-column-item footer-special-item">
          Email: <a href="">abc@xyz.com</a>
        </div>
      </div>
    </div>
    <div class="footer-lower">
      ...
      <ul class="social-media">
        ...
        <li class="social-media-item">
          <a href=""><i class="fa-brands fa-square-tumblr"></i></a>
        </li>
      </ul>
    </div>
  </div>
